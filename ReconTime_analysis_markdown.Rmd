...
# pitch  
pitch_model = glmer(RT_aud ~ f_SOA*c_is_onset*f_duration*is_task_relevant*c_pitch + (1*f_SOA*c_is_onset*f_duration*is_task_relevant*c_pitch|sub_id), family=Gamma(link="identity"), data=all_event_table)
summary(pitch_model)

# category 
cate_model = glmer(RT_aud ~ f_SOA*c_is_onset*f_duration*is_task_relevant*cate_num + (1*f_SOA*c_is_onset*f_duration*is_task_relevant*cate_num|sub_id), family=Gamma(link="identity"), data=all_event_table)
summary(cate_model)

# orientation 
ori_model = glmer(RT_aud ~ f_SOA*c_is_onset*f_duration*is_task_relevant*ori_num + (1*f_SOA*c_is_onset*f_duration*is_task_relevant*ori_num|sub_id), family=Gamma(link="identity"), data=all_event_table)
summary(ori_model)
```
