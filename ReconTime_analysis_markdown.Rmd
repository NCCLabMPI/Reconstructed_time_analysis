...
full_model = glmer(RT_aud ~ c_SOA*is_onset*c_duration*is_task_relevant +
                     (1*c_SOA*is_onset*c_duration*is_task_relevant|sub_num),
...
reduced_model = glmer(RT_aud ~ c_SOA*is_onset*is_task_relevant +
                        (1*c_SOA*is_onset*is_task_relevant|sub_num),
                      family=Gamma(link="identity"), data=all_event_table)
...
offset_model = glmer(RT_aud ~ c_SOA*c_duration*is_task_relevant +
                       (1*c_SOA*c_duration*is_task_relevant | sub_num) +                     
...
# post-hoc ttest with factorial SOA and duration

f_offset_event_table = offset_event_table %>% mutate(f_SOA = as.factor(SOA))
f_offset_event_table = f_offset_event_table %>% mutate(f_duration = as.factor(duration))

f_offset_model = glmer(RT_aud ~ f_SOA*f_duration*is_task_relevant +
                       (1*f_SOA*f_duration*is_task_relevant | sub_num) +                     
...
mega_model = glmer(RT_aud ~ c_SOA*c_is_onset*c_duration*c_task_relevant +
                     (1*c_SOA*c_is_onset*c_duration*c_task_relevant | sub_num) +
...
mega_model2 = glmer(RT_aud ~ c_SOA*c_is_onset*c_task_relevant +
                     (1*c_SOA*c_is_onset*c_task_relevant | sub_num) +
...
reduced_offset_model = glmer(RT_aud ~ c_SOA*is_task_relevant +
                               (1*c_SOA*is_task_relevant|sub_num) +
...
hist(p, 20) + abline(v=0.05, col="red") + abline(v=0.01, col="blue")
```
