...
# fixed effects: SOA (ordinal), SOA-Lock (as is_onset,  numeric, centered), Task-relevance (as is relevant, numeric, centered)
# random effects: Subject ID, Duration (ordinal)

model1 = glmer(RT_aud ~ f_SOA*is_onset*is_task_relevant +
                     (1*f_SOA*is_onset*is_task_relevant | sub_id)+
                     (1*f_SOA*is_onset*is_task_relevant | f_duration),
...
offset_model = glmer(RT_aud ~ f_SOA*f_duration*is_task_relevant +
                       (1*f_SOA*f_duration*is_task_relevant | sub_id) +                     
...
# pitch  
pitch_model = glmer(RT_aud ~ f_SOA*is_onset*f_duration*is_task_relevant*c_pitch + (1*f_SOA*is_onset*f_duration*is_task_relevant*c_pitch|sub_id), family=Gamma(link="identity"), data=all_event_table)
summary(pitch_model)

# category 
cate_model = glmer(RT_aud ~ f_SOA*is_onset*f_duration*is_task_relevant*cate_num + (1*f_SOA*is_onset*f_duration*is_task_relevant*cate_num|sub_id), family=Gamma(link="identity"), data=all_event_table)
summary(cate_model)

# orientation 
ori_model = glmer(RT_aud ~ f_SOA*is_onset*f_duration*is_task_relevant*ori_num + (1*f_SOA*is_onset*f_duration*is_task_relevant*ori_num|sub_id), family=Gamma(link="identity"), data=all_event_table)
summary(ori_model)
```
...
mega_model = glmer(RT_aud ~ f_SOA*c_is_onset*f_duration*c_task_relevant +
                     (1*f_SOA*c_is_onset*f_duration*c_task_relevant | sub_id) +
                     (1*f_SOA*c_is_onset*f_duration*c_task_relevant | c_pitch) +
                     (1*f_SOA*c_is_onset*f_duration*c_task_relevant | category), 
                   family=Gamma(link="identity"), data=all_event_table)
summary(mega_model)
Anova(mega_model)
rsq.glmm(mega_model)
...
mega_model2 = glmer(RT_aud ~ f_SOA*c_is_onset*c_task_relevant +
...
#mega_model3 = glmer(RT_aud ~ f_SOA*c_is_onset*c_task_relevant*f_duration*c_pitch*category +
#                     (1*f_SOA*c_is_onset*c_task_relevant*f_duration*c_pitch*category | sub_id), 
#                   family=Gamma(link="identity"), data=all_event_table)
...
#brm_SOA_SOA_lock_model = brm(RT_aud ~ f_SOA*is_onset*f_duration*is_task_relevant + (1*f_SOA*is_onset*f_duration*is_task_relevant|sub_id), all_event_table, family=Gamma(link="identity"),save_pars = save_pars(all = TRUE))
