...
top_axes[0].legend(frameon=False)
...
fig.savefig(Path(save_root, "Experiment1-figure3.svg"), transparent=True, dpi=dpi)
fig.savefig(Path(save_root, "Experiment1-figure3.png"), transparent=True, dpi=dpi)
plt.close()
print(save_root)
