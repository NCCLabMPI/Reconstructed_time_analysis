...
for (subNum in subNums ){
  for (ses in sessions ){
    ...
    # z-score of iRT_vis and iRT_aud and division in high an low
    ...
    event_table = event_table %>% mutate(z_RT_vis = (RT_vis-mean(RT_vis))/sd(RT_vis))
    event_table = event_table %>% mutate(z_RT_aud = (RT_aud-mean(RT_aud))/sd(RT_aud))
