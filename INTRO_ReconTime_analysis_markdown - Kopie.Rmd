...
target_event_table <- target_event_table %>%
  mutate(RT_aud_1000 = RT_aud * 1000)

cor_aud = ggscatter(target_event_table , x = "RT_aud_1000", y = "iRT_aud",
          add = "reg.line", conf.int = TRUE, 
          cor.coef = TRUE, cor.coef.coord = c(200, 1100), cor.method = "pearson")+
  labs(title = "Estimation performance auditory task ", tag = "B")+
  xlab("Objective reaction time [ms]")+
...
# visual iRT
target_event_table <- target_event_table %>%
  mutate(RT_vis_1000 = RT_vis * 1000)

cor_vis = ggscatter(target_event_table , x = "RT_vis_1000", y = "iRT_vis",
          add = "reg.line", conf.int = TRUE, 
          cor.coef = TRUE, cor.coef.coord = c(200, 1100), cor.method = "pearson")+
