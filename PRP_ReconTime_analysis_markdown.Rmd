...
sub_folder = paste0('sub-', Lab_ID, subNum)
ses_folder = 'ses-1'
file_name = paste0(sub_folder, '_ses-1_run-0_task-auditory_events')
...
mean_RTaud_practice = mean(all_aud_pratice_table$RT_aud)
sd_RTaud_practice = sd(all_aud_pratice_table$RT_aud)
