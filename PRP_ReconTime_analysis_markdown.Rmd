...
for (sub_num in subNums) {
  perf = perf %>% add_row(sub_num = as.character(sub_num),
                          ...
                          RT_aud = mean(target_event_table$RT_aud[raw_event_table$sub_num == sub_num], na.rm = TRUE)*1000,
                          RT_vis = mean(target_event_table$RT_vis[raw_event_table$sub_num == sub_num], na.rm = TRUE)*1000)
}
